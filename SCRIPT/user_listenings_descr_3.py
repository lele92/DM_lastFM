...
artist_name = "muse"
artist_name_without_string = "muse"

out_file_user_listening = open("../OUTPUT/"+artist_name_without_string+"/user_listenings_"+artist_name_without_string+".csv", "w")
out_file_user_listening.write("user_id,num_ascolti_totali,num_ascolti_artista,settimane_totali,settimane_artista\n")
...
out_file_distribution_user.write("user_id,week_year,num_ascolti_totali,num_ascolti_artista\n")

out_file_global = open("../OUTPUT/"+artist_name_without_string+"/user_listenings_single_row_"+artist_name_without_string+".csv", "w")
out_file_global.write("user_id,num_ascolti_totali,num_ascolti_artista,settimane_totali,settimane_artista\n")
